      ...
      <div className="min-h-screen bg-background relative">
        ...
        <div className="min-h-screen p-8 py-16">
          <div className="max-w-2xl mx-auto w-full">
            {/* Header */}
            <div className="mb-20">
              <h1 className="garamond text-3xl font-medium mb-2 tracking-tight">
                Tjalling van der Schaar
              </h1>
              <p className="garamond text-base text-muted-foreground/60">
                Reflections, ideas, and progress.
              </p>
            </div>
            ...
            <div className="space-y-12">
              {blogPosts.map((note) => (
                <Link to={`/blog/${note.id}`} key={note.id} className="block">
                  <article className="group cursor-pointer p-4 -mx-4 rounded-lg hover:bg-muted/30 transition-all">
                    <div className="flex items-baseline gap-3 mb-2">
                      <time className="garamond text-sm text-muted-foreground/60 whitespace-nowrap">
                    ...
                    <h2 className="garamond text-2xl font-medium mb-3 tracking-tight group-hover:text-foreground/80 transition-colors">
                      {note.title}
                    </h2>
                    <p className="garamond text-base leading-relaxed text-foreground/90 group-hover:text-foreground transition-colors">
                      {note.content}
                    </p>
                  </article>
                </Link>
            ...
            <div className="mt-20 pt-8 border-t border-border/20 text-center">
              <p className="garamond text-sm text-muted-foreground/60">
