            ...
            <div className="space-y-10 text-left">
              ...
              <section>
                ...
                <div className="garamond text-sm space-y-3 leading-relaxed">
                  ...
                  <p className="text-foreground font-medium">Royal Dutch Academy for Arts and Sciences — Amongst the ten best papers written by high schoolers in the Netherlands</p>
                </div>
              </section>
